export default {
    settings: {
      ...
      scheduling: {
        ...
        accountSchedulingStrategyDefault: 'Default (sticky session + load-aware)',
        accountSchedulingStrategyRoundRobin: 'Strict Round Robin',
        accountSchedulingStrategySystem: 'System default (follows the setting above)',
        accountSchedulingStrategyHint: 'Default: a session reuses its last account (better upstream prompt-cache hits). Strict round robin: every request rotates across available accounts, ignoring session stickiness and account priority; switching back restores stickiness automatically. previous_response_id conversations still pin their original account.',
        platformSchedulingStrategyTitle: 'Platform-level Scheduling Strategy',
        platformSchedulingStrategyHint: 'Platform-level strategies take priority over the system-level setting above; platforms set to "System default" follow it. You can force default or strict round robin per platform.',

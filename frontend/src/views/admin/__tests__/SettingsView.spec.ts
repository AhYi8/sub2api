...
const {
  ...
  getGlobalScheduledTest,
  updateGlobalScheduledTest,
  getGroups,
  listProxies,
  getProviders,
  updateProvider,
  ...
  getGlobalScheduledTest: vi.fn().mockResolvedValue({
    id: 1,
    account_id: null,
    model_id: "",
    platform_models: {},
  ...
  updateGlobalScheduledTest: vi.fn().mockImplementation(async (payload) => payload),
  getGroups: vi.fn(),
  listProxies: vi.fn(),
  getProviders: vi.fn(),
...
vi.mock("@/api", () => ({
  adminAPI: {
    ...
    scheduledTests: {
      getGlobal: getGlobalScheduledTest,
      updateGlobal: updateGlobalScheduledTest,
    },
    groups: {
      getAll: getGroups,
    },
